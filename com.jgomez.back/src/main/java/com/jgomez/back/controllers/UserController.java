...
import com.jgomez.back.controllers.dto.UserDTO;
    ...
    public ResponseEntity<?> findById(@PathVariable Long id) {
        ...
        if (userOptional.isPresent()) {
            ...
            UserDTO userDTO = UserDTO.builder()
                    ...
                    .rolid((new ArrayList<Rol>(user.getRoles())).get(0).getId())
...
//        long users_id=((User)userSaved).getId();

        Rol rol = new Rol();
        rol.setName(userDTO.getRol());
